/*
 * Hyperspeed — ported from ReactBits (https://reactbits.dev/backgrounds/hyperspeed)
 * to a framework-free module so the static cover page keeps its no-React build.
 *
 * The original is a React component; everything below the options object is the
 * same framework-agnostic three.js code, with the useEffect/useRef wrapper
 * replaced by initHyperspeed(container, options) returning a dispose handle.
 */
